...
export const buttonVariants = tv({
  ...
  variants: {
    theme: {
      primary: [
        'bg-primary-600 [type="submit"]:bg-primary-600 text-light',
        'border border-solid border-primary-600',
        'hover:bg-primary-700 hover:border-primary-700',
        'outline-primary-200 dark:outline-primary-400',
      ],
      secondary: [
        'bg-secondary-600 [type="submit"]:bg-secondary-600 text-light',
      ...
      tertiary: [
        'bg-tertiary-600 [type="submit"]:bg-tertiary-600 text-light',
      ...
      gray: [
        'bg-grayscale-100 [type="submit"]:bg-grayscale-100 text-dark',
        'dark:bg-grayscale-800 [type="submit"]:dark:bg-grayscale-800 dark:text-grayscale-50',
      ...
      success: [
        'bg-success-600 [type="submit"]:bg-success-600 text-light',
      ...
      failure: [
        'bg-failure-600 [type="submit"]:bg-failure-600 text-light',
      ...
      warning: [
        'bg-warning-500 [type="submit"]:bg-warning-500 text-light',
      ...
      dark: [
        'bg-dark [type="submit"]:bg-dark text-light',
        'dark:bg-light [type="submit"]:bg-light dark:text-dark',
      ...
      light: [
        'bg-light [type="submit"]:bg-light text-dark',
        'dark:bg-dark [type="submit"]:dark:bg-dark dark:text-light',
      ...
      outlineGray: [
        'bg-none text-grayscale-400',
        'border border-solid border-grayscale-400',
        'hover:bg-grayscale-50 dark:hover:bg-grayscale-800',
      ...
      grayPrimary: [
        ...
        'bg-grayscale-50 [type="submit"]:bg-grayscale-50 dark:bg-grayscale-800 [type="submit"]:dark:bg-grayscale-800',
        'hover:bg-grayscale-200 dark:hover:bg-grayscale-700',
        ...
        'dark:border-grayscale-800 dark:hover:border-grayscale-700',
